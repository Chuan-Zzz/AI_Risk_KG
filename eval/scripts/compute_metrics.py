...
def calc_level1() -> dict:
    data = load_json_files("level1_entity/annotator_*.json")
...
def calc_level2() -> dict:
    data = load_json_files("level2_risk_chain/annotator_*.json")
...
def calc_level3() -> dict:
    data = load_json_files("level3_inference/annotator_*.json")
